            ...
            content: [
              {
                ...
                text: [
                  ...
                  "- Provider usage must describe real intended use of OpenAI, Tavily, fal, Gradium, and Pioneer. Use an empty string only if a provider is not used.",
                  "- generatedMediaPrompt must be a strong fal prompt with no text embedded in the image.",
                ].join("\n"),
              },
            ],
          },
